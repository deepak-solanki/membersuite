...
class Data extends Concierge {
    ...
    public function FromClassMetadata($resultobject) {
        ...
        if ($responsearr['bFields']['bFieldMetadata']) $resultset = $responsearr['bFields']['bFieldMetadata'];
        else if ($responsearr['bFields']['bKeyValueOfstringanyType']) $resultset = $responsearr['bFields']['bKeyValueOfstringanyType'];

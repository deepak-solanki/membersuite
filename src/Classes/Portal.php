...
use Membersuite\Classes\Concierge;
...
class Portal extends Concierge {
    ...
    public function ConvertLeadRequest($accesskey, $associationid, $secreteaccessid, $leadID, $newOwnerID, $sendEmailToNewOwner, $entityNameOrID, $createIndividualRecord, $relationshipTypeID,
            $opportunityNameOrID, $msoFollowUpActivity) {

...
class SearchAPI extends Concierge {
    ...
    public function GenerateInsertionOrderInvoicesRequest($accesskey, $associationid, $secreteaccessid, $issueId, $batchName, $invoiceTermsId, $searchToUse, $automaticallyEmailInvoices,

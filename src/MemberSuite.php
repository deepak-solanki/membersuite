...
use Membersuite\Classes\Event;
use Membersuite\Classes\Finance;
use Membersuite\Classes\Fundraising;
use Membersuite\Classes\Integration;
use Membersuite\Classes\Membership;
use Membersuite\Classes\Order;
use Membersuite\Classes\Portal;
use Membersuite\Types\DataTransferObjects;
use Membersuite\Types\Address;
use Membersuite\Types\CommandShortcut;
use Membersuite\Types\MemberSuiteObject;
use Membersuite\Jobs\SubscriptionFulfillmentJobManifest;
use Membersuite\Jobs\SubscriptionRenewalJobManifest;
use Membersuite\Searching\Expr;
use Membersuite\Searching\Search;
use Membersuite\Searching\SearchOperationGroup;
...
class MemberSuite {
    ...
    public function CreatePortalSecurityToken($portalUserName, $signingCertificateId, $signature) {
        ...
        $getresponse = $this->login->CreateToken($this->accesskeyId, $this->associationId, $this->secretaccessId, $portalUserName, $signingCertificateId, $signature
        );
        return $getresponse;
    }
    ...
    public function LoginToPortal($portalUserName, $portalPassword) {
        ...
        $response = $this->login->LoginToPortal($this->accesskeyId, $this->associationId, $this->secretaccessId, $portalUserName, $portalPassword
        );
    ...
    public function WhoAmI() {
        ...
        $whoamiresonse = $this->login->WhoAmIRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
    ...
    public function ListAllObjects($includeAbstract, $baseObjectType = '') {
        ...
        $objectresponse = $this->metadata->ListObjectRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $includeAbstract, $baseObjectType
        );
    ...
    public function DescribeObject($objecttype) {
        ...
        $objectresponse = $this->metadata->DescribeObjectRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objecttype
        );
    ...
    public function Save($object) {
        ...
        $dataresponse = $this->data->SaveDataRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $object
        );
    ...
    public function Get($Id) {
        $dataresponse = $this->data->GetDataRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $Id);
    ...
    function GetObject($Id) {
        $dataresponse = $this->data->GetObject($this->accesskeyId, $this->associationId, $this->secretaccessId, $Id);
    ...
    public function ExecuteMSQL($MSQL, $StartRecord, $MaximumNumOfRecord) {
        ...
        $queryresponse = $this->search->CreateExecuteMSQL($this->accesskeyId, $this->associationId, $this->secretaccessId, $MSQL, $StartRecord, $MaximumNumOfRecord
        );
    ...
    public function ExecuteSearch($SearchToExecute, $StartRecord, $MaximumNumOfRecord) {
        ...
        $searchresponse = $this->search->CreateExecuteSearch($this->accesskeyId, $this->associationId, $this->secretaccessId, $SearchToExecute, $StartRecord, $MaximumNumOfRecord
        );
    ...
    public function ExecuteSearches($searchesToExecute, $startRecord, $maximumNumberOfRecordsToReturn = '') {
        ...
        $searchresponse = $this->search->ExecuteSearchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchesToExecute, $startRecord, $maximumNumberOfRecordsToReturn
        );
    ...
    public function GetResumeAsHtml($resumeID) {
        ...
        $response = $this->job->GetResumeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $resumeID
        );
    ...
    public function RecordJobProgress($jobID, $additionalLogText, $newStatus) {
        ...
        $response = $this->data->RecordJobRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $jobID, $additionalLogText, $newStatus
        );
    ...
    public function RecordErrorAuditLog($msoErrorAuditLog) {
        ...
        $response = $this->data->RecordErrorAuditLogRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoErrorAuditLog
        );
        return $response;
    }
    ...
    public function Query($objectType, $whereClause, $orderBy, $startIndex) {
        ...
        $response = $this->data->DataQuery($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType, $whereClause, $orderBy, $startIndex
        );
    ...
    public function GetObjectBySearch($searchToUse, $fieldToUseAsObjectIdentifier) {
        ...
        $response = $this->data->GetObjectBySearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToUse, $fieldToUseAsObjectIdentifier
        );
    ...
    public function GetObjectsBySearch($searchToUse, $fieldToUseAsObjectIdentifier, $startRecord, $maximumNumberOfRecordsToReturn) {
        ...
        $response = $this->data->GetObjectsBySearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToUse, $fieldToUseAsObjectIdentifier, $startRecord,
    ...
    public function QuerySingle($objectType, $whereClause) {
        ...
        $response = $this->data->DataQuerySingle($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType, $whereClause
        );
    ...
    public function DownloadFile($fileID) {
        ...
        $response = $this->data->DownloadFileRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $fileID
        );
    ...
    public function GetName($recordID) {
        ...
        $response = $this->data->GetNameRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordID
        );
    ...
    public function GetNames($recordID) {
        ...
        $response = $this->data->GetNamesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordID
        );
    ...
    public function Delete($id) {
        ...
        $response = $this->data->DeleteRecord($this->accesskeyId, $this->associationId, $this->secretaccessId, $id
        );
    ...
    public function GetAutoNumberSeedInfo($objectName) {
        ...
        $response = $this->data->GetAutoNumberSeedInfoRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectName
        );
    ...
    public function UpdateAutoNumberSeed($objectName, $newSeed) {
        ...
        $response = $this->data->UpdateAutoNumberSeedRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectName, $newSeed
        );
    ...
    public function MassUpdate($recordType, $recordIdentifiers, $msoNewValues) {
        ...
        $response = $this->data->MassUpdateRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordType, $recordIdentifiers, $msoNewValues
        );
    ...
    public function MassDelete($recordType, $recordIdentifiers) {
        ...
        $response = $this->data->MassDeleteRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordType, $recordIdentifiers
        );
    ...
    public function MassAssignEntitlements($msoEntitlement, $idsToAssign) {
        ...
        $response = $this->data->MassAssignEntitlementsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoEntitlement, $idsToAssign
        );
    ...
    public function GetConciergeAPIVersion() {
        ...
        $response = $this->diagn->GeAPIVersionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
    ...
    public function FlushCaches() {
        ...
        $response = $this->diagn->FlushCachesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
    ...
    public function GetDiscussionBoard($targetID) {
        ...
        $response = $this->diagn->GetDiscussionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $targetID
        );
    ...
    public function SendEmailsToSubscribedEntities($discussionPostId) {
        ...
        $response = $this->diagn->SendEmailRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $discussionPostId
        );
    ...
    public function GetFileCabinetRootFolder($targetID) {
        ...
        $response = $this->documnt->GetFileCabinetRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $targetID
        );
    ...
    public function DescribeFolder($folderID) {
        ...
        $response = $this->documnt->DescribeFolderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $folderID
        );
    ...
    public function DeleteFolderTree($folderID) {
        ...
        $response = $this->documnt->DeleteFolderTreeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $folderID
        );
    ...
    public function SearchForFilesWithinFolder($folderID, $textToSearch, $startRecord, $pageSize) {
        ...
        $response = $this->documnt->SearchForFilesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $folderID, $textToSearch, $startRecord, $pageSize
        );
    ...
    public function SearchForFilesGlobally($textToSearch, $startRecord, $pageSize) {
        ...
        $response = $this->documnt->SearchForFilesGloballyRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $textToSearch, $startRecord, $pageSize
        );
    ...
    public function GetApplicableRegistrationFees($eventID, $entityID) {
        ...
        $response = $this->event->RegistrationFeeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $eventID, $entityID
        );
    ...
    public function GetEventManifest($eventID, $entityID, $registrationFeeID) {
        ...
        $response = $this->event->GetEventManifestRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $eventID, $entityID, $registrationFeeID
        );
    ...
    public function TransferRegistration($sourceRegistrationID, $destinationRegistrationFee, $batchToUse) {
        ...
        $response = $this->event->TransferRegistrationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $sourceRegistrationID, $destinationRegistrationFee, $batchToUse
        );
    ...
    public function GetAvailableExhibitorRegistrationWindows($showID, $entityID) {
        ...
        $response = $this->event->GetAvailableExhibitorRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $showID, $entityID
        );
    ...
    public function GetAvaialbleExhibitBooths($showID, $entityID) {
        ...
        $response = $this->event->GetAvaialbleExhibitBoothsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $showID, $entityID
        );
    ...
    public function RetrieveOrCreateExhibitorRecord($showID, $entityID) {
        ...
        $response = $this->event->RetrieveOrCreateExhibitRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $showID, $entityID
        );
    ...
    public function RetrieveAccessibleExhibitorRecords($showID, $entityID) {
        ...
        $response = $this->event->RetrieveAccessibleRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $showID, $entityID
        );
    ...
    public function CheckForExhibitorContactRestriction($exhibitorID, $contactTypeID) {
        ...
        $response = $this->event->CheckForExhibitorRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $exhibitorID, $contactTypeID
        );
    ...
    /// <returns></returns>
    /// <remarks></remarks>
    public function CloneEvent($srcEventID, $msoNewEventValues, $includeConfirmationEmails, $includeRegistrationFees, $includeRegistrationQuestions, $includeEventMerchandise,
            $includeSupplementalInformationLinks, $includeSessionTracks, $includeSessionTimeslots, $includeSponsorshipInformation, $includeResources, $includeRooms) {

        $response = $this->event->CloneEventRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $srcEventID, $msoNewEventValues, $includeConfirmationEmails,
                $includeRegistrationFees, $includeRegistrationQuestions, $includeEventMerchandise, $includeSupplementalInformationLinks, $includeSessionTracks, $includeSessionTimeslots,
                $includeSponsorshipInformation, $includeResources, $includeRooms
        );
    ...
    public function SaveFiscalYear($msFiscalYear, $numberOfPeriods) {
        ...
        $response = $this->finance->SaveFiscalYearRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msFiscalYear, $numberOfPeriods
        );
    ...
    public function SaveCredit($msCredit) {
        ...
        $response = $this->finance->SaveCreditRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msCredit
        );
    ...
    public function VoidCredit($creditID) {
        ...
        $response = $this->finance->VoidCreditRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $creditID
        );
    ...
    public function GetRelatedPaymentsForInvoice($invoiceID) {
        ...
        $response = $this->finance->GetRelatedPaymentsForInvoiceRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $invoiceID
        );
    ...
    public function GetOpenBatches() {
        ...
        $response = $this->finance->GetOpenBatchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
    ...
    public function CreateInvoice($msInvoice) {
        ...
        $response = $this->finance->CreateInvoiceRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msInvoice
        );
    ...
    public function ProcessWriteOff($msWriteOff) {
        ...
        $response = $this->finance->ProcessWriteOffRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msWriteOff
        );
    ...
    public function VoidWriteOff($writeOffID) {
        ...
        $response = $this->finance->VoidWriteOffRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $writeOffID
        );
    ...
    public function DeleteWriteOff($writeOffID) {
        ...
        $response = $this->finance->DeleteWriteOffRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $writeOffID
        );
    ...
    public function WriteOffMultipleInvoices($msWriteOffTemplate, $invoicesToWriteOff) {
        ...
        $response = $this->finance->WriteOffMultipleInvoicesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msWriteOffTemplate, $invoicesToWriteOff
        );
    ...
    public function AdjustInvoice($msInvoice) {
        ...
        $response = $this->finance->AdjustInvoiceRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msInvoice
        );
    ...
    public function ProcessRefund($refund) {
        ...
        $response = $this->finance->ProcessRefundRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $refund
        );
    ...
    public function GetAllProductsInBatch($batchIDs) {
        ...
        $response = $this->finance->GetAllProductsInBatchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $batchIDs
        );
    ...
    public function AdjustRefund($refund) {
        ...
        $response = $this->finance->AdjustRefundRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $refund
        );
    ...
    public function WipeProFormaInvoices($wipeInvoicesBefore) {
        ...
        $response = $this->finance->WipeProFormaInvoicesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $wipeInvoicesBefore
        );
        return $response;
    }
    ...
    public function CancelInvoice($invoiceID) {
        ...
        $response = $this->finance->CancelInvoiceRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $invoiceID
        );
    ...
    public function PostBatches($batchIDs, $newBatchForProFormaInvoices = "") {
        ...
        $response = $this->finance->PostBatchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $batchIDs, $newBatchForProFormaInvoices
        );
    ...
    public function ChangeBatch($targetBatchID, $transactionsToChange) {
        ...
        $response = $this->finance->ChangeBatchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $targetBatchID, $transactionsToChange
        );
    ...
    public function UnPostBatches($batchIDs) {
        ...
        $response = $this->finance->UnPostBatchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $batchIDs
        );
    ...
    public function DownloadBatches($batchIDs) {
        ...
        $response = $this->finance->DownloadBatchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $batchIDs
        );
    ...
    public function GenerateBatchReadinessReport($batches) {
        ...
        $response = $this->finance->GenerateBatchReadinessReportRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $batches
        );
    ...
    public function RecordPayment($paymentToRecord) {
        ...
        $response = $this->finance->RecordPaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentToRecord
        );
    ...
    public function ProcessCreditCardPayment($paymentToRecord, $creditCardToProcess, $antiDuplicationKey) {
        ...
        $response = $this->finance->ProcessCreditCardPaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentToRecord, $creditCardToProcess, $antiDuplicationKey
        );
    ...
    public function AdjustPayment($paymentToAdjust) {
        ...
        $response = $this->finance->AdjustPaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentToAdjust
        );
    ...
    public function ProcessInvoiceAdjustment($msInvoiceAdjustment, $paymentAdjustmentInstructions) {
        ...
        $response = $this->finance->ProcessInvoiceAdjustmentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msInvoiceAdjustment, $paymentAdjustmentInstructions
        );
    ...
    public function RefundPayment($paymentID, $batchID, $instructions, $memo, $autoGenerateRefund) {
        ...
        $response = $this->finance->RefundPaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentID, $batchID, $instructions, $memo, $autoGenerateRefund
        );
    ...
    public function ReversePayment($paymentID, $batchID, $instructions, $memo) {
        ...
        $response = $this->finance->ReversePaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentID, $batchID, $instructions, $memo
        );
    ...
    public function VoidPayment($paymentID) {
        ...
        $response = $this->finance->VoidPaymentRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $paymentID
        );
    ...
    public function EditRevenueRecognitionSchedule($revenueRecognitionSchedule) {
        ...
        $response = $this->finance->EditRevenueRecognitionScheduleRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $revenueRecognitionSchedule
        );
    ...
    public function EditBillingSchedule($billingSchedule) {
        ...
        $response = $this->finance->EditBillingScheduleRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $billingSchedule
        );
    ...
    public function CancelBillingSchedule($billingScheduleId) {
        ...
        $response = $this->finance->CancelBillingScheduleRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $billingScheduleId
        );
        return $response;
    }
    ...
    public function ProcessBillingScheduleEntry($scheduleID, $date) {
        ...
        $response = $this->finance->ProcessBillingScheduleEntryRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $scheduleID, $date
        );
        return $response;
    }
    ...
    public function RecognizeDeferralRevenue($fiscalYearID, $periodNumber) {
        ...
        $response = $this->finance->RecognizeDeferralRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $fiscalYearID, $periodNumber
        );
        return $response;
    }
    ...
    public function ClosePeriod($fiscalYearID, $periodNumber) {
        ...
        $response = $this->finance->ClosePeriodRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $fiscalYearID, $periodNumber
        );
        return $response;
    }
    ...
    public function ReopenFiscalPeriod($fiscalYearID, $periodNumber, $deleteRecognizedRevenue) {
        ...
        $response = $this->finance->ReopenFiscalPeriodRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $fiscalYearID, $periodNumber, $deleteRecognizedRevenue
        );
        return $response;
    }
    ...
    public function DescribeProducts($entityID, $productsToDescribe) {
        ...
        $response = $this->finance->DescribeProductsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityID, $productsToDescribe
        );
        return $response;
    }
    ...
    public function GenerateDonorAcknowledgmentLetter($GiftID, $logActivity) {
        ...
        $response = $this->fund->GenerateDonorRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $GiftID, $logActivity
        );
        return $response;
    }
    ...
    public function GenerateDonorAcknowledgmentLetters($GiftID, $logActivity) {
        ...
        $response = $this->fund->GenerateDonorsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $GiftID, $logActivity
        );
        return $response;
    }
    ...
    public function GenerateDonorReceipt($GiftID) {
        ...
        $response = $this->fund->GenerateDonorReceiptRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $GiftID
        );
        return $response;
    }
    ...
    public function GenerateDonorReceipts($listOfGifts) {
        ...
        $response = $this->fund->GenerateDonorReceiptsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $listOfGifts
        );
        return $response;
    }
    ...
    public function CreateGift($msoGiftToCreate) {
        ...
        $response = $this->fund->CreateGiftRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoGiftToCreate
        );
        return $response;
    }
    ...
    public function EditGift($msoGiftToEdit) {
        ...
        $response = $this->fund->EditGiftRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoGiftToEdit
        );
        return $response;
    }
    ...
    public function VoidGift($giftIdToVoid) {
        ...
        $response = $this->fund->VoidGiftRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $giftIdToVoid
        );
        return $response;
    }
    ...
    public function ProcessPremiums($giftToProcess, $batchID) {
        ...
        $response = $this->fund->ProcessPremiumsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $giftToProcess, $batchID
        );
        return $response;
    }
    ...
    public function GetZipCodesWithinSpecifiedRadiusByZip($zipCode, $radiusInMiles) {
        ...
        $response = $this->fund->GetZipCodesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $zipCode, $radiusInMiles
        );
        return $response;
    }
    ...
    public function GetZipCodesWithinSpecifiedRadiusByCityState($city, $twoLetterState, $radiusInMiles) {
        ...
        $response = $this->fund->GetZipCodesbyCityRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $city, $twoLetterState, $radiusInMiles
        );
        return $response;
    }
    ...
    public function PingExtensionService($msoService) {
        ...
        $response = $this->integration->PingExtensionServiceRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoService
        );
        return $response;
    }
    ...
    public function ExecuteMailMerge($searchToUse, $mailMergeTemplate, $outputFormat, $createActivity, $activityTypeID = "", $activityMemo = "") {
        ...
        $response = $this->integration->ExecuteMailMergeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToUse, $mailMergeTemplate, $outputFormat, $createActivity,
                $activityTypeID, $activityMemo
        );
        return $response;
    }
    ...
    public function SetConfigurationSetting($ns, $name, $value, $description) {
        ...
        $response = $this->integration->SetConfigurationSettingRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $ns, $name, $value, $description
        );
        return $response;
    }
    ...
    public function GetConfigurationSetting($ns, $settingName) {
        ...
        $response = $this->integration->GetConfigurationSettingRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $ns, $settingName
        );
        return $response;
    }
    ...
    public function GetAllConfigurationSettings($ns = '') {
        ...
        $response = $this->integration->GetAllConfigurationSettingRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $ns
        );
        return $response;
    }
    ...
    public function ProcessRenewals($membershipOrganizationID, $batchID, $renewalBatchName, $searchToUse, $sendOutEmails, $jobStatusNotificationEmail) {
        ...
        $response = $this->membership->ProcessRenewalRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipOrganizationID, $batchID, $renewalBatchName, $searchToUse,
                $sendOutEmails, $jobStatusNotificationEmail
        );
        return $response;
    }
    ...
    public function GetPrimaryMembership($membershipOrganizationID, $entityID) {
        ...
        $response = $this->membership->GetPrimaryMembershipRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipOrganizationID, $entityID
        );
        return $response;
    }
    ...
    public function GetDefaultChapterProduct($membershipTypeID, $chapterID) {
        ...
        $response = $this->membership->GetDefaultChapterProductRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipTypeID, $chapterID
        );
        return $response;
    }
    ...
    public function GetDefaultSectionProduct($membershipTypeID, $sectionID) {
        ...
        $response = $this->membership->GetDefaultSectionProductRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipTypeID, $sectionID
        );
        return $response;
    }
    ...
    public function GetApplicableMembershipDuesProducts($membershipOrganizationID, $entityID) {
        ...
        $response = $this->membership->GetApplicableMembershipDuesProductsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipOrganizationID, $entityID
        );
        return $response;
    }
    ...
    public function GetApplicableChaptersForMembershipType($membershipTypeID) {
        ...
        $response = $this->membership->GetApplicableChaptersRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipTypeID
        );
        return $response;
    }
    ...
    public function SuggestChapter($membershipOrganizationID, $potentialMemberID) {
        ...
        $response = $this->membership->SuggestChapterRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $membershipOrganizationID, $potentialMemberID
        );
        return $response;
    }
    ...
    public function DropMemberships($searchToUseForDrop, $terminationReasonID, $newStatusID, $terminationDate) {
        ...
        $response = $this->membership->DropMembershipsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToUseForDrop, $terminationReasonID, $newStatusID, $terminationDate
        );
        return $response;
    }
    ...
    public function PreviewEmailBlast($templateToUse, $search, $destinationEmail, $count) {
        ...
        $response = $this->membership->PreviewEmailBlastRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $templateToUse, $search, $destinationEmail, $count
        );
        return $response;
    }
    ...
    public function GetEmailTemplate($nameOrIDOfTemplate) {
        ...
        $response = $this->membership->GetEmailTemplateRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $nameOrIDOfTemplate
        );
        return $response;
    }
    ...
    public function SendEmail($emailTemplateNameOrID, $targets = '', $overrideEmailAddress = '') {
        ...
        $response = $this->membership->SendEmailRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $emailTemplateNameOrID, $targets, $overrideEmailAddress
        );
        return $response;
    }
    ...
    public function GetAllEmailTemplates() {
        ...
        $response = $this->membership->GetAllEmailTemplatesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function SendCustomizedEmail($template, $targets, $overrideEmailAddress = '') {
        ...
        $response = $this->membership->SendCustomizedEmailRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $template, $targets, $overrideEmailAddress
        );
        return $response;
    }
    ...
    public function GetAssociationConfiguration() {
        ...
        $response = $this->metadata->GetAssociationConfigurationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function AddFavorite($cmd) {
        ...
        $response = $this->metadata->AddFavoriteRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $cmd
        );
        return $response;
    }
    ...
    public function GetUserPreferences() {
        ...
        $response = $this->metadata->GetUserPreferencesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetCommandDefinition($commandName) {
        ...
        $response = $this->metadata->GetCommandDefinitionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $commandName
        );
        return $response;
    }
    ...
    public function GetAllCommands() {
        ...
        $response = $this->metadata->GetAllCommandsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetConsoleMetadata() {
        ...
        $response = $this->metadata->GetConsoleMetadataRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function DescribeObjectBuiltInFields($objectType) {
        ...
        $response = $this->metadata->DescribeObjectBuiltInFieldsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType
        );
        return $response;
    }
    ...
    public function GetDefaultDashboard($nameOfCommand, $context) {
        ...
        $response = $this->metadata->GetDefaultDashboardRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $nameOfCommand, $context
        );
        return $response;
    }
    ...
    public function GetDefaultDataEntryPageLayout($objectType) {
        ...
        $response = $this->metadata->GetDefaultDataEntryPageLayoutRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType
        );
        return $response;
    }
    ...
    public function GetDefaultPortalPageLayout($objectType) {
        ...
        $response = $this->metadata->GetDefaultPortalPageLayoutRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType
        );
        return $response;
    }
    ...
    public function GetDefaultData360PageLayout($objectType) {
        ...
        $response = $this->metadata->GetDefaultData360PageLayoutRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType
        );
        return $response;
    }
    ...
    public function UpdateClassMetadata($objectType, $metadataToSave) {
        ...
        $response = $this->metadata->UpdateClassMetadataRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectType, $metadataToSave
        );
        return $response;
    }
    ...
    public function DetermineObjectType($objectID) {
        ...
        $response = $this->metadata->DetermineObjectTypeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $objectID
        );
        return $response;
    }
    ...
    public function UpdateCustomField($packet) {
        ...
        $response = $this->metadata->UpdateCustomFieldRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $packet
        );
        return $response;
    }
    ...
    public function UpdateTabs($newTabs) {
        ...
        $response = $this->metadata->UpdateTabsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $newTabs
        );
        return $response;
    }
    ...
    public function UpdateAssociationSettings($newSettings) {
        ...
        $response = $this->metadata->UpdateAssociationSettingsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $newSettings
        );
        return $response;
    }
    ...
    public function Get360Packet($primarySearch, $oneClicks) {
        ...
        $response = $this->metadata->Get360PacketRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $primarySearch, $oneClicks
        );
        return $response;
    }
    ...
    public function VoidOrder($orderID) {
        ...
        $response = $this->order->VoidOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $orderID
        );
        return $response;
    }
    ...
    public function GetOrderForm($order) {
        ...
        $response = $this->order->GetOrderFormRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $order
        );
        return $response;
    }
    ...
    public function GetOrderFormForProduct($productID) {
        ...
        $response = $this->order->GetOrderFormForProductRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $productID
        );
        return $response;
    }
    ...
    public function ProcessOrder($msOrderToProcess, $antiDuplicationKey = '') {
        ...
        $response = $this->order->ProcessOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msOrderToProcess, $antiDuplicationKey
        );
        return $response;
    }
    ...
    public function CheckLongRunningTaskStatus($taskInfo) {
        ...
        $response = $this->order->CheckLongRunningTaskStatusRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $taskInfo
        );
        return $response;
    }
    ...
    public function SaveDetails($msoOrder) {
        ...
        $response = $this->order->SaveDetailsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoOrder
        );
        return $response;
    }
    ...
    public function UpdateOrderBillingInfo($orderID, $ccNumber, $ccvCode, $expDate, $billingAddress) {
        ...
        $response = $this->order->UpdateOrderBillingInfoRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $orderID, $ccNumber, $ccvCode, $expDate, $billingAddress
        );
        return $response;
    }
    ...
    public function UpdateInvoiceBillingInfo($invoiceID, $poNumber, $billingEmailAddress, $billingAddress) {
        ...
        $response = $this->order->UpdateInvoiceBillingInfoRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $invoiceID, $poNumber, $billingEmailAddress, $billingAddress
        );
        return $response;
    }
    ...
    public function AdjustOrder($msOrderToAdjust) {
        ...
        $response = $this->order->AdjustOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msOrderToAdjust
        );
        return $response;
    }
    ...
    public function ProcessReturn($msReturn, $autoGenerateRefunds) {
        ...
        $response = $this->order->ProcessReturnRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msReturn, $autoGenerateRefunds
        );
        return $response;
    }
    ...
    public function SaveFulfillmentBatch($msoFulfillmentBatch) {
        ...
        $response = $this->order->SaveFulfillmentBatchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msoFulfillmentBatch
        );
        return $response;
    }
    ...
    public function ProcessFulfillmentBatch($fulfillmentBatchID) {
        ...
        $response = $this->order->ProcessFulfillmentBatchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $fulfillmentBatchID
        );
        return $response;
    }
    ...
    public function GenerateRenewalOrder($targetID) {
        ...
        $response = $this->order->GenerateRenewalOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $targetID
        );
        return $response;
    }
    ...
    public function FulfillOrder($orderID, $itemsToFulfill) {
        ...
        $response = $this->order->FulfillOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $orderID, $itemsToFulfill
        );
        return $response;
    }
    ...
    public function ShipOrder($orderID, $itemsToShip, $shipDate, $shippingMethod, $trackingNumber) {
        ...
        $response = $this->order->ShipOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $orderID, $itemsToShip, $shipDate, $shippingMethod, $trackingNumber
        );
        return $response;
    }
    ...
    public function BillOrder($orderID) {
        ...
        $response = $this->order->BillOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $orderID
        );
        return $response;
    }
    ...
    public function PreProcessOrder($msOrderToFinalize) {
        ...
        $response = $this->order->PreProcessOrderRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msOrderToFinalize
        );
        return $response;
    }
    ...
    public function ProcessInventoryTransaction($inventoryTransaction) {
        ...
        $response = $this->order->ProcessInventoryTransactionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $inventoryTransaction
        );
        return $response;
    }
    ...
    public function GetAccessiblePortalForms($entityID) {
        ...
        $response = $this->portal->GetAccessiblePortalFormsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityID
        );
        return $response;
    }
    ...
    public function DescribePortalForm($formID, $entityID) {
        ...
        $response = $this->portal->DescribePortalFormRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $formID, $entityID
        );
        return $response;
    }
    ...
    public function CheckEntitlement($type, $entityID, $context) {
        ...
        $response = $this->portal->CheckEntitlementRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $type, $entityID, $context
        );
        return $response;
    }
    ...
    public function AdjustEntitlementAvailableQuantity($entityID, $typeOfEntitlement, $context, $amountToAdjust) {
        ...
        $response = $this->portal->AdjustEntitlementAvailableQuantityRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityID, $typeOfEntitlement, $context, $amountToAdjust
        );
        return $response;
    }
    ...
    public function ListEntitlements($entityID, $type = "") {
        ...
        $response = $this->portal->ListEntitlementsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityID, $type
        );
        return $response;
    }
    ...
    public function GetPortalUrl() {
        ...
        $response = $this->portal->GetPortalUrlRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetAppropriateRateCard($issueId, $advertiserId) {
        ...
        $response = $this->portal->GetAppropriateRateCardRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $issueId, $advertiserId
        );
        return $response;
    }
    ...
    public function ConvertLead($leadID, $newOwnerID, $sendEmailToNewOwner, $entityNameOrID, $createIndividualRecord, $relationshipTypeID, $opportunityNameOrID, $msoFollowUpActivity) {
        ...
        $response = $this->portal->ConvertLeadRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $leadID, $newOwnerID, $sendEmailToNewOwner, $entityNameOrID,
                $createIndividualRecord, $relationshipTypeID, $opportunityNameOrID, $msoFollowUpActivity
        );
        return $response;
    }
    ...
    public function GetAvailableAssociationTemplates() {
        ...
        $response = $this->portal->GetAvailableAssociationTemplatesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function ProvisionAssociation($sourceAssociationID, $msoAssociation, $confirmationEmail, $includeData) {
        ...
        $response = $this->portal->ProvisionAssociationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $sourceAssociationID, $msoAssociation, $confirmationEmail, $includeData
        );
        return $response;
    }
    ...
    public function MoveAssociation($sourceAssociationID, $destinationDatabase) {
        ...
        $response = $this->portal->MoveAssociationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $sourceAssociationID, $destinationDatabase
        );
        return $response;
    }
    ...
    public function ObliterateAssociation($associationID) {
        ...
        $response = $this->portal->ObliterateAssociationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $associationID
        );
        return $response;
    }
    ...
    public function GetDatabaseServers() {
        ...
        $response = $this->portal->GetDatabaseServersRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function RenderReport($manifest) {
        ...
        $response = $this->portal->RenderReportRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $manifest
        );
        return $response;
    }
    ...
    public function LoadReportDefinition($manifest) {
        ...
        $response = $this->portal->LoadReportDefinitionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $manifest
        );
        return $response;
    }
    ...
    public function ListAllReports() {
        ...
        $response = $this->portal->ListAllReportsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetReportInformation($reportName) {
        ...
        $response = $this->portal->GetReportInformationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $reportName
        );
        return $response;
    }
    ...
    public function GetAllCharts() {
        ...
        $response = $this->portal->GetAllChartsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetAllKPIDefinitions() {
        ...
        $response = $this->portal->GetAllKPIDefinitionsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function BuildChart($chartName, $context = "") {
        ...
        $response = $this->portal->BuildChartRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $chartName, $context
        );
        return $response;
    }
    ...
    public function GetKPIs($kpisToRun) {
        ...
        $response = $this->portal->GetKPIsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $kpisToRun
        );
        return $response;
    }
    ...
    public function RetrievePortalInformationByUrl($hostName) {
        ...
        $response = $this->login->RetrievePortalInformationByUrlRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $hostName
        );
        return $response;
    }
    ...
    public function RetrievePortalInformationByID() {
        ...
        $response = $this->login->RetrievePortalInformationByIDRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetRecordPermission($recordID) {
        ...
        $response = $this->login->GetRecordPermissionRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordID
        );
        return $response;
    }
    ...
    public function Login($userName, $password, $loginDestination) {
        ...
        $response = $this->login->LoginRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userName, $password, $loginDestination
        );
        return $response;
    }
    ...
    public function ResetPassword($userID, $newPassword) {
        ...
        $response = $this->login->ResetPasswordRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userID, $newPassword
        );
        return $response;
    }
    ...
    public function SendWelcomePortalUserEmail($portalUserId, $emailAddress) {
        ...
        $response = $this->login->SendWelcomePortalUserEmailRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $portalUserId, $emailAddress
        );
        return $response;
    }
    ...
    public function SendForgottenPortalPasswordEmail($portalUserName, $nextUrl) {
        ...
        $response = $this->login->SendForgottenPortalPasswordEmailRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $portalUserName, $nextUrl
        );
        return $response;
    }
    ...
    public function GetOrCreatePortalUserForEntity($entityId) {
        ...
        $response = $this->login->GetOrCreatePortalUserForEntityRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityId
        );
        return $response;
    }
    ...
    public function SearchAndGetOrCreatePortalUser($loginIDOrEmail) {
        ...
        $response = $this->login->SearchAndGetOrCreatePortalUserRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $loginIDOrEmail
        );
        return $response;
    }
    ...
    public function LoginWithHash($userName, $hash) {
        ...
        $response = $this->login->LoginWithHashRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userName, $hash
        );
        return $response;
    }
    ...
    public function LoginPortalUserWithHash($portalUserName, $hash) {
        ...
        $response = $this->login->LoginPortalUserWithHashRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userName, $hash
        );
        return $response;
    }
    ...
    public function CreateTemporaryAccessKey($userName, $password, $secretAccessKey) {
        ...
        $response = $this->login->CreateTemporaryAccessKeyRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userName, $password, $secretAccessKey
        );
        return $response;
    }
    ...
    public function CreateTemporaryAccessKeyWithHash($userName, $hash, $secretAccessKey) {
        ...
        $response = $this->login->CreateTemporaryAccessKeyWithHashRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userName, $hash, $secretAccessKey
        );
        return $response;
    }
    ...
    public function CreateConsoleSecurityToken($userId, $signingCertificateId, $signature) {
        ...
        $response = $this->login->CreateConsoleSecurityTokenRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $userId, $signingCertificateId, $signature
        );
        return $response;
    }
    ...
    public function LoginWithToken($securityToken, $signingCertificateId, $signature) {
        ...
        $response = $this->login->LoginWithTokenRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $securityToken, $signingCertificateId, $signature
        );
        return $response;
    }
    ...
    public function ChangePassword($oldPassword, $newPassword) {
        ...
        $response = $this->login->ChangePasswordRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $oldPassword, $newPassword
        );
        return $response;
    }
    ...
    public function SwitchAssociation() {
        ...
        $response = $this->login->SwitchAssociationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function Logout() {
        ...
        $response = $this->login->LogoutRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function RecordRecordAccess($recordID, $cmd) {
        ...
        $response = $this->login->RecordRecordAccessRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordID, $cmd
        );
        return $response;
    }
    ...
    public function RecordError($description) {
        ...
        $response = $this->login->RecordErrorRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $description
        );
        return $response;
    }
    ...
    public function GetAllUsersThanCanAccessCurrentAssociation() {
        ...
        $response = $this->login->GetAllUsersThanCanAccessCurrentAssociationRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function GetAccessibleEntitiesForEntity($entityId) {
        ...
        $response = $this->login->GetAccessibleEntitiesForEntityRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityId
        );
        return $response;
    }
    ...
    public function DescribeSearch($searchType, $searchContext) {
        ...
        $response = $this->search->DescribeSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchType, $searchContext
        );
        return $response;
    }
    ...
    public function GetSearchFieldMetadataFromFullPath($searchType, $searchContext, $fieldFullPaths) {
        ...
        $response = $this->search->GetSearchFieldMetadataFromFullPathRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchType, $searchContext, $fieldFullPaths
        );
        return $response;
    }
    ...
    public function DescribeCompiledSearch($searchToInspect) {
        ...
        $response = $this->search->DescribeCompiledSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToInspect
        );
        return $response;
    }
    ...
    public function DescribeCompiledSearches($searchesToInspect) {
        ...
        $response = $this->search->DescribeCompiledSearchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchesToInspect
        );
        return $response;
    }
    ...
    public function ExecuteSearchWithFileOutput($searchToExecute, $searchOutputType, $abortIfZeroResults) {
        ...
        $response = $this->search->ExecuteSearchWithFileOutputRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchToExecute, $searchOutputType, $abortIfZeroResults
        );
        return $response;
    }
    ...
    public function ConvertMQLToSearch($msqlStatement) {
        ...
        $response = $this->search->ConvertMQLToSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $msqlStatement
        );
        return $response;
    }
    ...
    public function GetBuiltInSearches($searchType) {
        ...
        $response = $this->search->GetBuiltInSearchesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchType
        );
        return $response;
    }
    ...
    public function LoadBuiltInSearch($searchName) {
        ...
        $response = $this->search->LoadBuiltInSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchName
        );
        return $response;
    }
    ...
    public function QuickSearch($searchType, $searchContext, $queryText, $startRecord, $maximumNumberOfRecordsToReturn) {
        ...
        $response = $this->search->QuickSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchType, $searchContext, $queryText, $startRecord,
                $maximumNumberOfRecordsToReturn
        );
        return $response;
    }
    ...
    public function GenerateQuickSearch($searchText, $searchContext, $queryText) {
        ...
        $response = $this->search->GenerateQuickSearchRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $searchText, $searchContext, $queryText
        );
        return $response;
    }
    ...
    public function GetPotentialEmailBlastRecipients() {
        ...
        $response = $this->search->GetPotentialEmailBlastRecipientsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId
        );
        return $response;
    }
    ...
    public function MatchVolunteersToJobOccurrences($jobOccurrenceID) {
        ...
        $response = $this->search->MatchVolunteersToJobOccurrencesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $jobOccurrenceID
        );
        return $response;
    }
    ...
    public function MatchJobOccurrencesToVolunteer($volunteerID) {
        ...
        $response = $this->search->MatchJobOccurrencesToVolunteerRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $volunteerID
        );
        return $response;
    }
    ...
    public function FulfillSubscriptions($jobManifest) {
        ...
        $response = $this->search->FulfillSubscriptionsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $jobManifest
        );
        return $response;
    }
    ...
    public function RenewSubscriptions($jobManifest) {
        ...
        $response = $this->search->RenewSubscriptionsRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $jobManifest
        );
        return $response;
    }
    ...
    public function GenerateInsertionOrderInvoices($issueId, $batchName, $invoiceTermsId, $searchToUse, $automaticallyEmailInvoices, $jobStatusNotificationEmail) {
        ...
        $response = $this->search->GenerateInsertionOrderInvoicesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $issueId, $batchName, $invoiceTermsId, $searchToUse,
                $automaticallyEmailInvoices, $jobStatusNotificationEmail
        );
        return $response;
    }
    ...
    public function Merge($source, $destination, $sourceFieldsToUse) {
        ...
        $response = $this->data->MergeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $source, $destination, $sourceFieldsToUse
        );
        return $response;
    }
    ...
    public function ValidateMultipleAddresses($entityIdentifiers) {
        ...
        $response = $this->data->ValidateMultipleAddressesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityIdentifiers
        );
        return $response;
    }
    ...
    public function ValidateAddress($addressToValidate) {
        ...
        $response = $this->data->ValidateAddressRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $addressToValidate
        );
        return $response;
    }
    ...
    public function FindPotentialDuplicates($mso, $ruleIDs, $spec, $startRecord, $pageSize) {
        ...
        $response = $this->data->FindPotentialDuplicatesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $mso, $ruleIDs, $spec, $startRecord, $pageSize
        );
        return $response;
    }
    ...
    public function PopulateCityStateFromPostalCode($addressToProcess) {
        ...
        $response = $this->data->PopulateCityStateFromPostalCodeRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $addressToProcess
        );
        return $response;
    }
    ...
    public function GetDefaultDuplicateDetectionRules($recordType) {
        ...
        $response = $this->data->GetDefaultDuplicateDetectionRulesRequest($this->accesskeyId, $this->associationId, $this->secretaccessId, $recordType
        );
        return $response;
    }
    ...
    public function GetPriorityConfiguration($entityID) {
        ...
        $response = $this->order->GetPriorityConfiguration($this->accesskeyId, $this->associationId, $this->secretaccessId, $entityID
        );
        return $response;
    }
